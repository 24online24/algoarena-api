        ...
        try {
            ...
            try (BufferedReader br = new BufferedReader(
                ...
                if (conn.getResponseCode() >= 200 && conn.getResponseCode() < 300) {
                    ...
                    return "Error: " + conn.getResponseCode() + " " + response.toString();
                }
            }
        } catch (IOException e) {
            e.printStackTrace();
            submission.setStatus("Error");
            submission.setMessage("Error occurred while making the HTTP request.");
            return "Error occurred while making the HTTP request.";
        }
